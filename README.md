...
| Array contains(where:)                   | 21.6 |   2604.3 |    24.0 |              40.2 |    ±5% |
...
| Contended 90% read / 10% write           |    - |    253.6 |    46.5 |            1447.9 |    ±6% |
| Contended 100% read                      |    - |    269.7 |    43.7 |             328.2 |    ±4% |
| Contended 100% write (a[i] += 1)         |    - |    271.7 |    77.5 |            2315.9 |    ±6% |
| Contended long read (count(where:), 10k) |    - | 419092.8 |  8974.5 |            1048.7 |    ±5% |
| Contended long read + 10% write          |    - | 380110.9 | 12344.5 |            2846.0 |   ±10% |
